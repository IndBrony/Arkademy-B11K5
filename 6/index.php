          ...
          <?php
            ...
            while ($employee = $employees->fetch_assoc()) {
              ...
              <tr>
                ...
                <td>
                  <button class="btn" data-toggle="modal" data-target="#deleteEmployeeModal<?=$employee['id']?>"><i class="fa fa-trash-o" style="font-size:24px;color:red"></i></button>
                </td>
                <td>
                  <button class="btn" data-toggle="modal" data-target="#editEmployeeModal<?=$employee['id']?>"><i class="fa fa-edit" style="font-size:24px;color:blue"></i></button>
                </td>
              </tr>
                    ...
                    <div class="modal-body">
                      <form action="" method="POST">
                        <div class="form-group">
                          ...
                          <input type="text" name="name" class="form-control" id="inputName" placeholder="Name..." value="<?=$employee['name']?>">
                        </div>
                        <div class="form-group">
                          <select class="form-control" name="work" id="selectWork">
                            <option>Work...</option>
                        ...
                        <div class="form-group">
                          <select class="form-control" name="salary" id="selectSalary">
                            <option>Salary...</option>
                            <option value="1" <?=$salary1?> >Rp.10.000.000</option>
                            <option value="2" <?=$salary2?> >Rp.12.000.000</option>
                          </select>
                        </div>
              ...
              <div class="modal fade" id="deleteEmployeeModal<?=$employee['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body" align="center">
                      <h4>Apakah Anda Yakin Akan Menghapus Data <?=$employee['name']?></h4>
                      <form action="" method="POST">
                        <input type="hidden" name="id" value="<?=$employee['id']?>">
